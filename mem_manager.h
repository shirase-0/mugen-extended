...
void *mu_realloc(MU_Allocator *allocator, void *current_memory, size_t n_size); // Reallocates the given memory block and saves the new address in the lp_mem_list
void mu_free(MU_Allocator *allocator, void *current_memory); // Free allocated block
